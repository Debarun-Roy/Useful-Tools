...
const BUTTON_GROUPS = {
  ...
  trig: [
    ...
    GRP('Trigonometric (Radians)', TRIG_RAD_BTNS),
    GRP('Trigonometric (Degrees)', TRIG_DEG_BTNS),
    GRP('Trigonometric (Hyperbolic)', TRIG_DEG_HYP),
    GRP('Trigonometric (Combined)', TRIG_DEG_COMBINED),
    GRP('Constants', CONST_BTNS),
  ],
  combined: [
    GRP('Numbers', DIGIT_BTNS),
