...
function MarkdownTool() {
  ...
  function renderMarkdown() {
    const html = trackTool('code.format', () => {
      // Sprint 24: Escape raw HTML entities first so user-typed content
      // cannot inject arbitrary tags. The regex substitutions below only
      // produce the small set of safe tags they are designed to produce.
      const safe = input
        .replace(/&/g, '&amp;')
        .replace(/</g, '&lt;')
        .replace(/>/g, '&gt;')
